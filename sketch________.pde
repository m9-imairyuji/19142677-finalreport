...
void draw(){
  ...
  text("Push z (shift + z) : Tranlate the machine in Z-axis direction", 900, 200);
  text("Left mouse click  ( Push r ) to Reset the machine Status", 900, 240);
